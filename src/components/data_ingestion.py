...
@dataclass
# DataIngestionConfig is a configuration container. Its job is only to store paths and settings required for data ingestion.
#It only answers:
#"Where should I save my raw data, train data, and test data?"
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('notebook\data\stud.csv')# Reading the csv file
            ...
            # above line saves the original dataset as data.csv in the artifacts folder for future use. 🚀 without indexing and with header(column name)
